#aflanders:
# NOTE: this code is taken directly from https://github.com/EmilyAlsentzer/clinicalBERT
# which originated from Willie Boag's mimic-tokenize github repository 
